            ...
            try
            {
                ...
                if (ItemName != "")
                {
                    if (!ItemExistOrNot(ItemName))
                    {
                        ...
                        string sql = "insert into ItemMaster values('" + ItemName + "', " + ItemRate + ", " + ItemQty + ")";
        ...
        top1:
            ...
            if (ItemName != "")
            {
                ...
                if (ItemExistOrNot(ItemName))
                {
                    ...
                    string sql = "update ItemMaster set ItemRate=" + ItemRate + " , ItemQty=" + ItemQty + " where ItemName= '" + ItemName + "' ";
